alarm_security_system_message = """
    ...
    -if the user input is related to 'open the door', 'unlock the door', 'unlock', please choose the door_operations as the tool call, fetch the exact username, password, from the user input, 
