...
# ---- Define Tools ----
@tool
async def arm_system(username: str) -> str:
...
@tool
async def disarm_system(username: str) -> str:
...
@tool
async def add_user(username: str, password: str, expire_from: str, expire_to: str) -> str:
...
@tool
async def remove_user(username: str) -> str:
...
@tool
async def door_operations(username: str, password: str, try_count: int) -> str:
...
@tool
async def default_tool(usermessage: str) -> str:
    """Default tool.
    Args:
